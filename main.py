...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1436843754647584843  # your guild/server ID

# channels
TRANSACTIONS_ID = 1507403146148974723
MATCH_TIMES_CHANNEL_ID = 1507403482452463747
ASSIGNMENTS_CHANNEL_ID = 1518121590993190924
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1507403506850468070  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1512871487143547012
CO_CAPTAIN_ROLE_ID = 1437265821767565342
EXECUTIVE_ROLE_ID = 1518121956933763233
TEAM_PLAYER_ROLE_ID = 1518121934284394567
APPLY_BOT_ID = 1509670518230614246  # (replace with your actual apply bot user ID)

# assignment roles
HEAD_REF_ROLE_ID = 1518121396998377643
REF_ROLE_ID = 1436843754999779502
HEAD_CASTER_ROLE_ID = 1518121370452492348
CASTER_ROLE_ID = 1512870478392332368
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="PGTC Transactions Bot – Command Guide",
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="PGTC Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the PGTC FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        ...
        "## • Application Forms\n\n"
        "> - PGTC has a various list of positions and applications to better help the league!,\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"PGTC{random.randint(1000, 9999)}"
